...
public class EventDrivenLara : MonoBehaviour
{
    ...
    float damage = 0;
    public bool lollipopEffectActive = false;
    public float lolliTimerValue = 0;
    public float lolliTimerMaxValue = 8f;
    ...
    void Start()
    {
        ...
        lolliTimerValue = lolliTimerMaxValue;
    }
    ...
    void Update()
    {
        ...
        if (!lollipopEffectActive && damage > 0)
        {
            //take damage
            health -= damage;
        ...
        if (lollipopEffectActive && lolliTimerValue > 0)
        {
            lolliTimerValue -= Time.deltaTime;
        }

        if (lolliTimerValue < 0)
        {
            lollipopEffectActive = false;
        }
    ...
    public void LollipopEffect()
    {
        lollipopEffectActive = true;
    }
}
